...
<nav class="navbar navbar-inverse navbar-fixed-top navbar-dark" role="navigation" style="background-color: #2a0744; ">
  <div class="container">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle" data-toggle="collapse"
                            data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
      <a class="navbar-brand" href="?page=home">NCI Computer Society</a> </div>
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li> <a href="?page=about">About Us</a> </li>
        <li> <a href="?page=event">Events</a> </li>
        <li> <a href="?page=contact">Contact</a> </li>
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Computer Support <b
>>>>>>> 3c588f54630f165f0b762de9a7fab4deb117e774
                                    class="caret"></b></a>
