...
--
-- Host: localhost
-- Generation Time: Dec 15, 2016 at 06:58 PM
...
`memberID` int(11) unsigned NOT NULL,
  ...
  `role` varchar(20) NOT NULL DEFAULT '2'
...
(1, 'Demo', '$2y$10$wJxa1Wm0rtS2BzqKnoCPd.7QQzgu7D/aLlMR5Aw3O.m9jx3oRJ5R2', 'demo@demo.com', '1'),
(2, 'user', '$2y$10$OkB.vORiqj3u6D6itCBhM.u1f4oO./KxzcePRsXkF7GdGMtWcjpt.', 'user@test.com', '2');
...
INSERT INTO `user_comments` (`id`, `blog_id`, `user_id`, `comment`, `commentDate`, `username`) VALUES
(1, 6, 2, '<p>tets comments</p>', '2016-12-15 22:17:18', 'user');
